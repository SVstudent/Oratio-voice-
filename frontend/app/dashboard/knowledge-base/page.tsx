      ...
      <DashboardLayout>
        <div className="flex items-center justify-center h-full">
          <div className="flex flex-col items-center gap-4 max-w-md text-center">
            ...
            <h2 className="text-xl font-semibold text-gray-900">Error Loading Knowledge Bases</h2>
        ...
        <div className="flex flex-col items-center justify-center h-full p-8">
          <div className="flex flex-col items-center max-w-md text-center space-y-4">
            <div className="h-24 w-24 rounded-2xl bg-blue-50/50 border-2 border-dashed border-blue-200 flex items-center justify-center">
              <IconDatabase className="h-12 w-12 text-gray-500" />
            </div>
            <h2 className="text-2xl font-bold text-gray-900">No knowledge bases yet</h2>
          ...
          <div className="p-8">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
              <div>
                ...
                <p className="text-gray-500 mt-1">Manage documents and data sources for your AI agents.</p>
              </div>
              <Link href="/dashboard/knowledge-base/create">
                <Button className="bg-accent hover:bg-accent/90 text-white shadow-lg shadow-accent/20">
                  <IconPlus className="h-4 w-4 mr-2" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {filteredKnowledgeBases.map((kb) => (
                <Link key={kb.knowledgeBaseId} href={`/dashboard/knowledge-base/${kb.knowledgeBaseId}`}>
                  <Card className="bg-blue-50/50 border-blue-200/50 p-6 hover:border-accent/50 hover:shadow-lg hover:shadow-accent/10 transition-all cursor-pointer">
              ...
              <Link href="/dashboard/knowledge-base/create">
                <Card className="bg-blue-50/30 border-2 border-dashed border-blue-200 hover:border-accent/50 hover:bg-blue-50/50 transition-all p-6 h-full flex items-center justify-center cursor-pointer group">
                  <div className="text-center">
                    ...
                    <h3 className="text-lg font-semibold text-gray-900 mb-1">Add Knowledge Base</h3>
                    <p className="text-sm text-gray-500">Upload documents and files for your agents.</p>
                  </div>
                </Card>
              </Link>
            </div>
