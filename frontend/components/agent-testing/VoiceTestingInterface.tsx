...
import { IconPhone, IconPhoneOff, IconMicrophone, IconRobot, IconUser, IconSparkles } from "@tabler/icons-react"
    ...
    try {
      ...
      ws.onmessage = async (event) => {
        ...
        if (event.data instanceof ArrayBuffer || event.data instanceof Blob) {
          ...
          // Don't queue audio if barge-in is active
          if (!isBargeIn) {
        ...
        try {
          ...
          switch (message.type) {
            ...
            case "barge_in":
              ...
              // Reset flag after a short delay to allow new audio
              setTimeout(() => {
                setIsBargeIn(false)
