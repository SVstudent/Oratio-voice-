...
class JWTValidator:
    ...
    def __init__(self):
        ...
        if not self.user_pool_id or not self.client_id:
            logger.warning("⚠️  COGNITO_USER_POOL_ID and COGNITO_CLIENT_ID not set - JWT validation will not work")
...
# Global JWT validator instance (lazy-loaded)
_jwt_validator = None
...
jwt_validator = None  # Will be set on first access
